...
$(function(){
	...
	$('#exportModal > form').submit(function(){
		...
		$('#exportModal > form #exportCancel').text('Go To Client Page');

		$('#exportModal > form #exportCancel').attr('onClick','javascript:location.href="http://localhost/smartmedia-client/view/"');
